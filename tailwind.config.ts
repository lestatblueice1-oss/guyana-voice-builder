  ...
  theme: {
    ...
    extend: {
      colors: {
        ...
        hope: {
          teal: "hsl(var(--hope-teal))",
          "teal-light": "hsl(var(--hope-teal-light))",
          "teal-dark": "hsl(var(--hope-teal-dark))",
        },
        action: {
          orange: "hsl(var(--action-orange))",
          "orange-light": "hsl(var(--action-orange-light))",
          "orange-dark": "hsl(var(--action-orange-dark))",
        },
